<template>
    <div class="mb-3">
        ...
        <div v-if="!optionalValidation" class="text-danger error-message">
            {{ optionalErrorMsg }}
        </div>
    </div>
</template>
...
export default {
    name: "ValidatedInput",
    props: ['label', 'type', 'errorMsg', 'modelValue', 'valid', 'optionalErrorMsg', 'optionalValidation', 'id', 'defaultValue'],
    computed: {
        inputValue: {
            get() {
