    ...
    <div class="row">
      <form class="archery-form-style">
        ...
        <div class="col-12" v-if="show.current === show.targets">
          <p>Bitte geben Sie die gewünschten Ziele an.</p>
          <div class="row" v-for="(target, key, index) in values.targets">
            <div class="col-8">
              ...
              <div v-if="!targetValidation[index]" class="text-danger error-message mb-2">Bitte befüllen oder löschen Sie das Ziel.</div>
            </div>
          ...
          <div class="row mb-4" v-for="(participant, index) in values.participants">
            <div class="col-8">
              ...
              <validated-input label="Nachname*" type="text"
                               ...
                               error-msg="Bitte befüllen Sie dieses Feld" :valid=true
                               :optional-validation=true></validated-input>
              <div v-if="!participantValidation[index]" class="text-danger error-message mb-2">Bitte befüllen Sie alle Felder mit einem Stern (*).</div>
            </div>
